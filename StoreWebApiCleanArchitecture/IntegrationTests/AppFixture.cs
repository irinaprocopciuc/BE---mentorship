...
namespace Store_Web_API.IntegrationTests
{
    public class AppFixture : WebApplicationFactory<Program>
    {
        ...
        private string connectionString = "Data Source=NBKR004093; Initial Catalog=WebStoreIntegration3; Integrated Security=SSPI;TrustServerCertificate=True";
